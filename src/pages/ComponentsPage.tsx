    ...
    return (
        <div className={dark ? "text-white" : "text-gray-900"}>
            <div className="mx-auto max-w-5xl">
                {/* Header */}
                <section
                    className={`border-b pb-10 ${dark ? "border-gray-800" : "border-gray-200"
                        }`}
                >
                    <p
                        className={`text-sm font-medium ${dark ? "text-gray-400" : "text-gray-400"
                            }`}
                    >
                        EaseUI / Components
                    </p>
                    ...
                    <p
                        className={`mt-4 max-w-2xl text-base leading-7 ${dark ? "text-gray-400" : "text-gray-500"
                            }`}
                    >
                ...
                {/* Quick intro */}
                <section
                    className={`border-b py-8 ${dark ? "border-gray-800" : "border-gray-200"
                        }`}
                >
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div
                            className={`w-fit rounded-md px-3 py-2 font-mono text-xs ${dark
                ...
                <section className="py-10">
                    <div
                        className={`grid border-l border-t sm:grid-cols-2 ${dark ? "border-gray-800" : "border-gray-200"
                            }`}
                    >
                        {components.map((component, index) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className={`group border-b border-r p-6 transition-colors ${dark
                                ...
                                >
                                    <div className="flex items-start justify-between">
                                        <span
                                            className={`text-xs font-medium ${dark ? "text-gray-600" : "text-gray-400"
                                                }`}
                                        >
                                        ...
                                        <span
                                            className={`text-[11px] font-medium ${available
                                                    ? "text-green-500"
                                                    : "text-amber-500"
                                                }`}
                                        >
                                    ...
                                    <div className="mt-8 flex items-end justify-between gap-6">
                                        <div>
                                            ...
                                            <p
                                                className={`mt-2 max-w-sm text-sm leading-6 ${dark ? "text-gray-400" : "text-gray-500"
                                                    }`}
                                            >
                                        ...
                                        <span
                                            className={`shrink-0 text-lg transition-transform duration-200 group-hover:translate-x-1 ${dark
                ...
                {/* Footer */}
                <section
                    className={`border-t py-8 ${dark ? "border-gray-800" : "border-gray-200"
                        }`}
                >
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <p
